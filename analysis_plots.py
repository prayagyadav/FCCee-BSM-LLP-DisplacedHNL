...
energy         = 91
collider       = 'FCC-ee'
inputDir       = '/eos/user/p/pryadav/COFFEA-FCC/FCCeeLLP/output_finalSel/'
#formats        = ['png','pdf']
formats        = ['png']
yaxis          = ['lin','log']
stacksig       = ['stack']
outdir         = '/eos/user/p/pryadav/COFFEA-FCC/FCCeeLLP/plots/'
splitLeg       = False
...
colors['DummySignal'] = ROOT.kWhite
...
plots['HNL'] = {'signal':{
                    ...
                    'DummySignal':['p8_ee_Zee_ecm91'], # DummySignal set with Zee
},
                'backgrounds':{
                    'Zbb':['p8_ee_Zbb_ecm91'],
                    'Zcc': ['p8_ee_Zcc_ecm91'],
...
legend['DummySignal'] = 'Dummy Signal'
