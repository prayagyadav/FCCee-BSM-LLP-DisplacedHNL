...
inputDir = "/eos/user/p/pryadav/COFFEA-FCC/FCCeeLLP/output_stage1/"
#inputDir = "output_stage1/"

#Output directory where the files produced at the final-selection level are
outputDir  = "/eos/user/p/pryadav/COFFEA-FCC/FCCeeLLP/output_finalSel/"
...
processList = {
    #run over a part of statistics from stage1
    'p8_ee_Zee_ecm91':{"fraction":0.1},
    'p8_ee_Ztautau_ecm91':{"fraction":0.1},
    'p8_ee_Zbb_ecm91':{"fraction":0.01},
    'p8_ee_Zcc_ecm91':{"fraction":0.1},
    'p8_ee_Zuds_ecm91':{"fraction":0.01},
}
